      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=8VV7gqq" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='圣诞祝福网页';
            con2.value='picture/tx.jpg';
            con3.value='圣诞节快乐';
            con4.value='祝你享尽圣诞佳节的快乐和圣诞的礼品。';
			con5.value='123456';
			con6.value='https://music.163.com/song/media/outer/url?id=1453639477.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
