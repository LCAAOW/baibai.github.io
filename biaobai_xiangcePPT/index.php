  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
			...
			con1.value='Slide';
            con2.value='One';
            con3.value='images/1.jpg';
            con4.value='Slide';
			con5.value='Two';
			con6.value='images/2.jpg';
			con7.value='Slide';
			con8.value='Three';
            con9.value='images/3.jpg';
            con10.value='Slide';
            con11.value='Four';
			con12.value='images/4.jpg';
			con13.value='Slide';
			con14.value='Five';
			con15.value='images/5.jpg';
			con16.value='next';
			con17.value='https://music.163.com/song/media/outer/url?id=518863209.mp3';
			con18.value='回忆相册PPT';
        }
    </script> 
  <!-- END #fh5co-projects -->
