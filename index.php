...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box">送你女朋友独特的WEB礼物.</h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    <div class="container">
      <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_xiangni',$viptem)) echo '<a class="vippng" href="biaobai_xiangni/" target="_blank"></a>'; ?><a href="biaobai_xiangni/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_xiangni/logo.png" alt="想你表白" class="img-responsive lazy">
         ...
         <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_kuanian',$viptem)) echo '<a class="vippng" href="biaobai_kuanian/" target="_blank"></a>'; ?><a href="biaobai_kuanian/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_kuanian/logo.png" alt="微信表白" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>跨年表白</h2>
            <p>表白网页制作</p>
          </div>
   ...
   <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_douyin',$viptem)) echo '<a class="vippng" href="biaobai_douyin/" target="_blank"></a>'; ?><a href="biaobai_douyin/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_douyin/logo.png" alt="微信表白" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>抖音微信表白</h2>
            <p>表白网页制作</p>
          </div>
       ...
       <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_gaobaiqiqiu',$viptem)) echo '<a class="vippng" href="biaobai_gaobaiqiqiu/" target="_blank"></a>'; ?><a href="biaobai_gaobaiqiqiu/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_gaobaiqiqiu/logo.png" alt="告白气球" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>告白气球</h2>
            <p>表白网页制作</p>
          </div>
 ...
 <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_aidegushi',$viptem)) echo '<a class="vippng" href="biaobai_aidegushi/" target="_blank"></a>'; ?><a href="biaobai_aidegushi/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_aidegushi/logo.png" alt="爱情故事" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>爱情故事</h2>
            <p>表白网页制作</p>
          </div>
         ...
         <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_liangju',$viptem)) echo '<a class="vippng" href="biaobai_liangju/" target="_blank"></a>'; ?><a href="biaobai_liangju/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_liangju/logo.png" alt="告白气球" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>背景图加两句表白</h2>
            <p>表白网页制作</p>
          </div>
 ...
 <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_jugong',$viptem)) echo '<a class="vippng" href="biaobai_jugong/" target="_blank"></a>'; ?><a href="biaobai_jugong/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_jugong/logo.png" alt="鞠躬表白" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>鞠躬表白</h2>
            <p>表白网页制作</p>
          </div>
  ...
  <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('qixi','biaobai_donghua',$viptem)) echo '<a class="vippng" href="biaobai_donghua/" target="_blank"></a>'; ?><a href="biaobai_donghua/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_donghua/logo.png" alt="完美表白" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>完美表白</h2>
            <p>表白网页制作</p>
          </div>
          </a> </div>
  <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_biaoqing',$viptem)) echo '<a class="vippng" href="biaobai_biaoqing/" target="_blank"></a>'; ?><a href="biaobai_biaoqing/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_biaoqing/logo.png" alt="表白表情包" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>表白表情包</h2>
            <p>表白网页制作</p>
          </div>
          </a> </div>
<div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_huaxin',$viptem)) echo '<a class="vippng" href="biaobai_huaxin/" target="_blank"></a>'; ?><a href="biaobai_huaxin/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_huaxin/logo.png" alt="表白信" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>表白信</h2>
            <p>表白网页制作</p>
          </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_xindong',$viptem)) echo '<a class="vippng" href="biaobai_xindong/" target="_blank"></a>'; ?><a href="biaobai_xindong/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_xindong/logo.png" alt="告白气球" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>女神名字画心</h2>
            <p>表白网页制作</p>
          </div>
         ...
         <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('biaobai','biaobai_wenzi',$viptem)) echo '<a class="vippng" href="biaobai_wenzi/" target="_blank"></a>'; ?><a href="biaobai_wenzi/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="biaobai_wenzi/logo.png" alt="漂浮的文字表白" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>漂浮的文字表白</h2>
            <p>表白网页制作</p>
          </div>
...
swal('本站状态:稳定运行中','\n\n所有注册码全部免费送，欢迎制作！','success'); function AddFavorite(title, url) {
